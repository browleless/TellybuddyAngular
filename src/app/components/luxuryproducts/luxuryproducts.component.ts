    ...
    let newLineItem: TransactionLineItem = {
      ...
      productItem: {
        ...
        luxuryProduct: {
          ...
          reorderQuantity: selectedLuxuryProd.reorderQuantity,
          productImagePath: selectedLuxuryProd.productImagePath,
          tags: selectedLuxuryProd.tags,
          category: selectedLuxuryProd.category,
          dealStartTime: selectedLuxuryProd.dealStartTime,
          dealEndTime: selectedLuxuryProd.dealEndTime,
          discountPrice: selectedLuxuryProd.discountPrice,
        },
      }
    };
